...
var sampleFilterSet = [[
        ...
        "multi",       //type of element with filter value (multi: multi-select, single: single-select, text: input box, rowIndexExclusion)
        ...
        "rowIdFilter",
        "row-index-exclusion", //this is a special kind of filter that excludes items based on an array of row IDs
        "row",
        "array"
    ]
];
